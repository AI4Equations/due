...
MU = 1.2          # Long-term mean level
SIGMA = 0.3       # Volatility (noise scale)

# Simulation Horizon & Volume
N_TRAJECTORIES = 15000   # Total number of independent training trajectories (H)
N_TEST_TRAJECTORIES = 1500 # Total number of independent test trajectories
T__TRAIN_HORIZON = 1.0          # Total time to simulate
T_TEST_HORIZON = 5.0
...
def save_to_mat(trajectories, filename):
    # Package the data exactly how the due loaders expect it
    mat_dictionary = {
